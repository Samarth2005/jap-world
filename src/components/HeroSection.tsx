  ...
  return (
    <section className="relative h-screen w-full overflow-hidden">
      <div className="absolute inset-0">
        <img src={heroBg} alt="3D printer depositing filament layers" className="w-full h-full object-cover" />
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full px-6 text-center">
        <motion.p
          ...
          transition={{ ...quintSlow, delay: 0.2 }}
        ...
        <motion.h1
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ ...quintSlow, delay: 0.4 }}
          className="text-4xl sm:text-6xl lg:text-7xl font-bold leading-tight max-w-4xl"
        >
          Precision in every <span className="text-gradient-cyan">layer</span>.
          <br />
        ...
        <motion.p
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ ...quintSlow, delay: 0.6 }}
        ...
        <motion.a
          ...
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ ...quintSlow, delay: 0.8 }}
      ...
      >
        <span className="text-[10px] uppercase tracking-[0.2em] text-muted-foreground font-mono-data">Scroll</span>
